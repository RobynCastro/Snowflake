...
#ifndef REACTIVE_IGVC_MOTIONCONTROLLER_H
#define REACTIVE_IGVC_MOTIONCONTROLLER_H
...
public:
    MotionController(double angular_vel_cap, double linear_vel_cap, double angular_vel_multiplier,
...
#endif // REACTIVE_IGVC_MOTIONCONTROLLER_H
