...
NAV2D.Navigator = function (options) {
  ...
  // marker for the path
  var pathMarker = new ROS2D.PathShape({
    size: 5,
    strokeSize: 1,
  ...
  // setup a listener for the robot path
  ...
  poseListener.subscribe(function (message) {
    ...
    // change the angle
    robotMarker.rotation = stage.rosQuaternionToGlobalTheta(message.pose.pose.orientation)
